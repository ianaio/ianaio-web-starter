# Contributing to IanaIO Web Starter
...
You can build every IanaIO Web Starter crate:
...
* [ ] The `authors` entry in `ianaio-web-starter/crates/foobar/Cargo.toml` is "The Rust and
