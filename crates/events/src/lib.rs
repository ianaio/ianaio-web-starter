...
///
/// ```rust
/// # use ianaio-web-starter_events::EventListenerPhase;
/// #
...
///
/// ```rust
/// # use ianaio-web-starter_events::{EventListenerOptions, EventListenerPhase};
/// #
...
///
/// ```rust
/// # use ianaio-web-starter_events::EventListenerOptions;
/// #
...
///
/// ```rust
/// # use ianaio-web-starter_events::EventListener;
...
impl EventListener {
    ...
    ///
    /// ```rust,no_run
    /// # use ianaio-web-starter_events::{EventListener, EventListenerOptions};
