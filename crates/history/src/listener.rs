...
///
/// This Listener has the same behaviour as the [`EventListener`][ianaio-web-starter_events::EventListener] from
/// `ianaio-web-starter` that the underlying callback will be unregistered when the listener is dropped.
