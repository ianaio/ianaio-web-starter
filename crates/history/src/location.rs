...
impl Location {
    ...
    ///
    /// Returns [`None`] if current location is not created by `ianaio-web-starter::history`.
    ///
    /// # Warning
    ///
    ...
    ///
    /// Returns [`None`] if state is not created by `ianaio-web-starter::history`, or state fails to downcast.
