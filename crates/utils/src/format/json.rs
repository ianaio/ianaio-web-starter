...
///
/// Usage of this API requires activating the `serde` feature of the `ianaio-web-starter-utils` crate.
...
pub trait JsValueSerdeExt: private::Sealed {
    ...
    /// the `ianaio-web-starter-utils` crate.
    /// # Example
    ///
    /// ```rust
    /// use wasm_bindgen::JsValue;
    /// use ianaio-web-starter_utils::format::JsValueSerdeExt;
    ///
    /// # fn no_run() {
    /// let array = vec![1,2,3];
